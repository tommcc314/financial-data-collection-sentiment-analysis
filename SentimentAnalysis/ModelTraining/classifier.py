#This code trains the Naive Bayes model to work with formal and legal tone of company filings.
...
def load_training_data():
    generic = open("GENERIC.txt", mode = 'r')
    company = open("COMPANY.txt", mode = 'r')
